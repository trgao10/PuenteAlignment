...
2. Set up an HTTP server under the folder *viewer/*. For instance, you can `cd viewer/` and type in `python -m SimpleHTTPServer 8000`. If you already placed the folder *viewer/* somewhere with HTTP services, feel free to skip this step.
